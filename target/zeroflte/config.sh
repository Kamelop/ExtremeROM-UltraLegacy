...
# Device configuration file for Galaxy S6 (Exynos)
TARGET_NAME="Galaxy S6 (Exynos)"
TARGET_CODENAME="zeroflte"
TARGET_ASSERT_MODEL=("SM-G920F")
TARGET_PLATFORM="exynos7420"
TARGET_FIRMWARE="SM-G920F/XEF/357011074242948"
TARGET_EXTRA_FIRMWARES=("")
TARGET_API_LEVEL=24
TARGET_PRODUCT_FIRST_API_LEVEL=21
TARGET_VNDK_VERSION=21
